...
export const styleParser = (document) => {
  const domdomElement = Array.from(
    document.querySelectorAll('[class*="my-"]'),
  );
      ...
      // spacing (padding, margin, gap)
        ...
        switch (key) {
          ...
          case "my":
            ...
            const parsedMy = isNaN(myValue) ? myValue : `${Number(myValue)}px`;
            domElement.style.marginTop = parsedMy;
            domElement.style.marginBottom = parsedMy;
            break;
      ...
      // strings based
        ...
        switch (key) {
          ...
          case "ovr":
            ...
            else domElement.style[valueMaps[key]] = overFlowMap[keyValueArr[1]];
            break;
          ...
          case "transition":
            ...
            const duration =
              dur.includes("ms") || dur.includes("s") ? dur : `${dur}s`;
          ...
          case "rounded":
            ...
            borderRadiusKeys.forEach(
              (i) => (domElement.style[i] = `${Number(borderRadius)}px`),
            );
            break;
